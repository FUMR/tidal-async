...
class TidalSession(object):
    ...
    async def login(self):
        if self._auth_info is not None:
            # TODO [$5f4c994834c25d000895b001]: refresh session
    ...
    # TODO [$5f4c994834c25d000895b002]: Move to the utils
...
class TidalMultiSession(TidalSession):
    ...
    # TODO [$5f4c994834c25d000895b003]: run request on random session
    # TODO [$5f4c994834c25d000895b004]: retry failed (404) requests (regionlock) on next session
    # TODO [$5f4c994834c25d000895b005]: try file download request on all sessions in queue fullness order
